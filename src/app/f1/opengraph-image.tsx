...
export const alt = 'F1 2026 Race Calendar & Travel Guides | Race Weekend';
  ...
  return new ImageResponse(
    (
      <div style={{ display: 'flex', width: 1200, height: 630, background: '#15151E', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(225,6,0,0.6) 0%, rgba(21,21,30,0.75) 50%, rgba(21,21,30,0.9) 100%)' }} />
        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '72px 88px', width: '100%' }}>
          <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
            <div style={{ background: '#E10600', borderRadius: 8, padding: '5px 16px', color: 'white', fontSize: 14, fontWeight: 800, letterSpacing: 1 }}>
              🏎 FORMULA 1
            </div>
