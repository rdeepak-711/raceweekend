...
export async function generateStaticParams() {
  return getExperienceStaticParams('f1');
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!exp) return {};
  return {
    title: `${exp.title} | F1 ${raceSlug}`,
    description: exp.shortDescription,
    alternates: { canonical: `https://raceweekend.app/f1/${raceSlug}/experiences/${slug}` },
    openGraph: {
      title: exp.title,
      description: exp.shortDescription ?? '',
...
export default async function F1ExperienceDetailPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 5, name: experience.title, item: `https://raceweekend.app/f1/${raceSlug}/experiences/${slug}` },
    ],
  };
      ...
      <div className="max-w-7xl mx-auto px-4 flex gap-8">
        ...
        <article className="flex-1 min-w-0">
          <div id="overview" className="mb-8">
            ...
            <div className="flex items-center gap-4 p-5 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-secondary)]">
              ...
              <a
                ...
                style={{ backgroundColor: 'var(--accent-f1)' }}
              >
          ...
          <section id="booking" className="pt-4">
            <div className="p-6 rounded-xl border border-[var(--accent-f1)]/30 bg-[var(--accent-f1-muted)]">
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 text-center py-3 rounded-full font-bold text-white bg-[var(--accent-f1)] hover:opacity-90 transition-opacity"
                >
                  Book on GetYourGuide →
                </a>
              </div>
        ...
        <ExperienceSuggestions
          ...
          basePath={`/f1/${raceSlug}/experiences`}
        />
      </div>
    </div>
    </>
