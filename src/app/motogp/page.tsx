...
export const metadata: Metadata = {
  title: 'MotoGP 2026 Season Calendar — Grand Prix Travel | Race Weekend',
  ...
  alternates: { canonical: 'https://raceweekend.app/motogp' },
  openGraph: {
    title: 'MotoGP 2026 Race Calendar | Race Weekend',
    description: 'Complete MotoGP 2026 season calendar. All Grand Prix races with dates, circuits, and travel guides.',
    images: [{ url: 'https://raceweekend.app/og/motogp.jpg', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    images: ['https://raceweekend.app/og/motogp.jpg'],
  },
};
